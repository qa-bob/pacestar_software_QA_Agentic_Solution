# Pacestar Software — QA Agentic Solution

> Automated QA framework for [Pacestar Software](http://pacestar.com/) built with Playwright + TypeScript.
...
| **Website** | [http://pacestar.com/](http://pacestar.com/) |
| **LinkedIn** | — |
| **City** | Gilbert |
| **Founded** | 1990 |
| **Funding** | Self-funded |
...
for **Pacestar Software**'s web application at http://pacestar.com/.
...
```
pacestar_software_QA_Agentic_Solution/
├── tests/
│   ├── smoke/
│   ├── functional/
│   └── regression/
